...
async _loadFontsAsync() {
 ...
 render() {
      ...
      <View style={styles.containerSettings}>
        ...
        <Text >Are you sure you would like to change you're current password?</Text>

        <View style={styles.container}>
          <Button
            title="Change password"
            onPress={() => Alert.alert(
              'An email will be sent you to change your password. Are you sure you would like to continue?',
              '',
              [
                {text: 'Yes', onPress: this.changePasswordVal},
